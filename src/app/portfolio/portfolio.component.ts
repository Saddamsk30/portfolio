...
export class PortfolioComponent {
  ...
  //     projectLink: 'https://github.com/barbaracalderon/oil-pump',
  ...
  //     projectLink: 'https://github.com/barbaracalderon/labquiz',
  ...
  //     projectLink: 'https://github.com/barbaracalderon/gradebook',
  ...
  //     projectLink: 'https://github.com/barbaracalderon/labscore',
  //     tags: [Tag.HTML5, Tag.CSS3],
  ...
  projects: Card[] = [
    {
      ...
      projectLink: 'https://test.mosambee.in/dashboard/login/',
